...
<div class="card ok">
<h2>Phase 10 complete</h2>
<p class="note">The adaptive producer, candidate screening, risk gates, isolated ledger, root strategy selector, and Pages publishing pipeline are operational. New entry signals are scheduled for 09:30 IST (04:00 UTC) on NIFTY weekdays. The separate 16:00 IST job is refresh-only and does not create a second entry signal.</p>
<p><a href="https://github.com/vishnuvcr/Nifty/actions/workflows/adaptive-paper-signal-producer-v1.yml">Open Adaptive workflow →</a></p>
</div>
